    ...
    <div className="container mx-auto max-w-md space-y-6 py-8">
      ...
      <Card className="border-0 shadow-md">
        ...
        <CardContent className="flex flex-col items-center">
          <Badge
            variant="outline"
            className="mb-4 border-0 bg-primary/10 text-primary"
          >
            掃描 QR Code 與其他玩家交換板塊
          </Badge>
          <div className="mb-6 rounded-xl bg-white p-4 shadow-inner">
            {playerData?.token ? (
              <Canvas
          ...
          <div className="rounded-lg bg-muted/30 p-5 text-sm">
            <p className="mb-3 text-center font-medium italic text-muted-foreground">
              — 逃逸路線：一則關於探險者的故事 —
            </p>
